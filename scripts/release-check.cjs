...
for (const asset of ['prisma.svg', 'prisma-launcher.svg', 'prisma-128.png', 'prisma-48.png', 'prisma-32.png']) {
...
if (script.includes('__EXP_PRISMA_BADGE_DATA__')) throw new Error('Badge placeholder remains in the distribution.');
